...
const HeaderMobile = () => {
  return (
    <Container className="flex flex-row h-16 items-center justify-around bg-logo1 z-50">
      <Link href="/" className="">
        <a className="flex flex-row flex-no-wrap items-center justify-between mr-20 xm:space-x-2 text-logo2">
          <div className="pt-2">
            <Logo width="60" height="60" />
          </div>
          <h1 className="font-semibold text-xl sm:text-2xl h1-font">
            Charanga Al Carrer
          </h1>
        </a>
      </Link>
